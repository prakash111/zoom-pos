...
MODULES=(pharmacy repairtechnician salon leadmanagement)
...
cmd_reset() {
    ...
    echo "  - drops their pharmacy_mod_* / repair_mod_* / salon_mod_* / lead_mod_* tables"
    ...
    php "$ROOT/artisan" tinker --execute='
        $slugs = ["pharmacy", "repairtechnician", "salon", "leadmanagement"];
        foreach ([
            ...
            "lead_mod_activities","lead_mod_leads","lead_mod_sources",
        ] as $t) {
