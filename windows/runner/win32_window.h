...
class Win32Window {
 public:
  ...
  // Show a window that was created but not shown yet.
  bool Show();
 ...
 private:
  ...
  // is passed when the non-client area is being created and enables passing
  // a pointer to the calling window structure. This lets us subclass
  // WindowProc for specific windowing rendering back to the specific Window
  // instance.
