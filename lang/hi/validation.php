...
return [
    ...
    */
    ...
    'accepted' => ':attribute फ़ील्ड स्वीकृत होनी चाहिए।',
    'accepted_if' => 'जब :other, :value हो, तो :attribute फ़ील्ड स्वीकृत होनी चाहिए।',
    ...
    'array_keys' => ':attribute फ़ील्ड में केवल निम्नलिखित कुंजियाँ होनी चाहिए: :values।',
    'ascii' => ':attribute फ़ील्ड में केवल सिंगल-बाइट अल्फ़ान्यूमेरिक वर्ण और चिह्न होने चाहिए।',
    'base64' => ':attribute फ़ील्ड एक मान्य Base64 स्ट्रिंग होनी चाहिए।',
    ...
    'declined_if' => 'जब :other, :value हो, तो :attribute फ़ील्ड अस्वीकृत होनी चाहिए।',
    'different' => ':attribute और :other फ़ील्ड अलग होनी चाहिए।',
    ...
    'doesnt_start_with' => ':attribute फ़ील्ड निम्न में से किसी के साथ शुरू नहीं होनी चाहिए: :values।',
    ...
    'gte' => [
        ...
        'string' => ':attribute फ़ील्ड :value वर्णों से बड़ी या बराबर होनी चाहिए।',
    ],
    'hex_color' => ':attribute फ़ील्ड एक मान्य हेक्साडेसिमल रंग होनी चाहिए।',
    ...
    'lt' => [
        ...
        'string' => ':attribute फ़ील्ड :value वर्णों से छोटी होनी चाहिए।',
    ],
    'lte' => [
        ...
        'string' => ':attribute फ़ील्ड :value वर्णों से छोटी या बराबर होनी चाहिए।',
    ],
    ...
    'max' => [
        ...
        'string' => ':attribute फ़ील्ड :max वर्णों से बड़ी नहीं होनी चाहिए।',
    ],
    'max_digits' => ':attribute फ़ील्ड में :max से अधिक अंक नहीं होने चाहिए।',
    'mimes' => ':attribute फ़ील्ड निम्न प्रकार की फ़ाइल होनी चाहिए: :values।',
    'mimetypes' => ':attribute फ़ील्ड निम्न प्रकार की फ़ाइल होनी चाहिए: :values।',
    'min' => [
    ...
    'missing_unless' => 'जब तक :other, :value न हो, तब तक :attribute फ़ील्ड अनुपस्थित होनी चाहिए।',
    ...
    'present_unless' => 'जब तक :other, :value न हो, तब तक :attribute फ़ील्ड मौजूद होनी चाहिए।',
