...
class _RedesignedMetricDashboardState extends State<RedesignedMetricDashboard> {
  ...
  Widget _buildTopAppBar(BuildContext context, bool isDark) {
    final top = widget.summary.topAppBar;
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text(
              top.storeName.isNotEmpty ? top.storeName[0].toUpperCase() : 'M',
          ...
          Stack(
            ...
            children: [
              ...
              if (top.unreadNotificationsCount > 0)
                Positioned(
                  top: 6,
                  right: 6,
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(
                      top.unreadNotificationsCount > 9 ? '9+' : top.unreadNotificationsCount.toString(),
