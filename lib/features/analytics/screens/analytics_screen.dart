              ...
              children: [
                LayoutBuilder(
                  builder: (context, constraints) => GridView.count(
                    ...
                    children: [
                      KpiCard(label: "Today's revenue", value: formatter.format(analytics.todayRevenue), sub: '${analytics.todayOrders} orders'),
                      KpiCard(label: "This month", value: formatter.format(analytics.monthRevenue), sub: '${analytics.monthOrders} orders'),
                      KpiCard(label: 'Average order', value: formatter.format(analytics.averageOrderValue)),
                      KpiCard(
                        label: 'Receivables',
                ...
                if (analytics.revenueTrend.isEmpty)
                  ...
                  SizedBox(height: 180, child: RevenueTrendChart(points: analytics.revenueTrend)),
                const SizedBox(height: 24),
