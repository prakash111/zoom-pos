...
class Company extends Model
{
    ...
    protected $fillable = [
        ...
        'language', 'default_locale', 'logo', 'favicon', 'primary_color', 'theme_color', 'pos_layout', 'pos_mode', 'receipt_format', 'status', 'plan_name', 'activation_key', 'registered_at', 'expires_at',
    ...
    {
        return in_array($this->pos_mode, ['restaurant', 'food_restaurant'], true);
    }
