...
class TenantNavRegistry
{
    ...
    public static function getInventorySection(): array
    {
        return self::normalizeSection([
            ...
            'items' => [
                ...
                ['key' => 'catalog', 'label' => 'eCommerce Storefront & Website', 'title' => 'eCommerce Storefront & Website', 'icon' => 'storefront', 'component' => 'catalog', 'permission' => 'catalog', 'target_endpoint' => '/api/tenant/views/catalog'],
            ],
        ]);
    }
        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['key' => 'catalog', 'label' => 'eCommerce Storefront & Website', 'icon' => 'storefront', 'component' => 'catalog', 'permission' => 'catalog'],
                ],
            ],
    ...
    public static function settingsTabItems(): array
    {
        return [
            ...
            [
                'key' => 'settings_storefront',
                'label' => 'Storefront Banner & Auth',
                'title' => 'Storefront Banner & Auth',
                'icon' => 'storefront',
                'component' => 'settings_storefront',
                'type' => 'link',
                'route' => 'tenant.settings.storefront',
                'target_endpoint' => '/api/tenant/views/settings-storefront',
                'parent' => 'settings',
                'parent_id' => 'settings',
                'permission' => 'settings',
            ...
            [
                'key' => 'settings_coupons',
                'label' => 'Coupons & Discounts',
                'title' => 'Coupons & Discounts',
                'icon' => 'local_offer',
                'component' => 'settings_coupons',
                'type' => 'link',
                'route' => 'tenant.settings.coupons',
                'target_endpoint' => '/api/tenant/views/settings-coupons',
                'parent' => 'settings',
                'parent_id' => 'settings',
                'permission' => 'settings',
            ...
            [
                'key' => 'settings_reviews',
                'label' => 'Product Reviews',
                'title' => 'Product Ratings & Reviews',
                'icon' => 'star',
                'component' => 'settings_reviews',
                'type' => 'link',
                'route' => 'tenant.settings.reviews',
                'target_endpoint' => '/api/tenant/views/settings-reviews',
                'parent' => 'settings',
                'parent_id' => 'settings',
                'permission' => 'settings',
