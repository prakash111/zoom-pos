    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 relative z-10">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-6 text-center">
            <div class="p-4 rounded-2xl bg-white/5 border border-white/5">
                <div class="text-3xl sm:text-5xl font-black tracking-tight text-white">2,500,000+</div>
            ...
            <div class="p-4 rounded-2xl bg-white/5 border border-white/5">
                <div class="text-3xl sm:text-5xl font-black tracking-tight text-white">1,200+</div>
