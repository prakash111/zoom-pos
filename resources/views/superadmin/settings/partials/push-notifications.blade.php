<form wire:submit="savePushNotifications" class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
        <button type="button" wire:click="testPushNotifications" wire:loading.attr="disabled" class="w-full sm:w-auto flex items-center justify-center rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-black text-slate-700 shadow-sm hover:bg-slate-50 disabled:opacity-60 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700">
        ...
        <button type="submit" wire:loading.attr="disabled" class="w-full sm:w-auto flex items-center justify-center rounded-2xl bg-indigo-600 px-6 py-3 text-sm font-black text-white shadow-lg hover:bg-indigo-700 disabled:opacity-60">
